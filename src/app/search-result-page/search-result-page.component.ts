...
import { EthAddress, Person, Address, Company } from '../model/models';
...
export class SearchResultPageComponent implements OnInit {
  ...
  public currNode: Address | EthAddress | Person | Company = null;
