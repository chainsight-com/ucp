...
import {
  ZilAddressScanPipeline,
  ZilAddressScanPipelineApiService,

  ZilFlowAddressTaintJobResultPage,

  ZilFlowRiskGraph,
  ZilFlowRiskWitnessPage
...
@Component({
  selector: 'app-zil-scan-result-page',
  templateUrl: './zil-scan-result-page.component.html',
  styleUrls: ['./zil-scan-result-page.component.scss']
})
export class ZilScanResultPageComponent implements OnInit, OnDestroy {


  public isLoadingPipeline = false;
  public pipeline: ZilAddressScanPipeline = {};

  // witness
  public isWitnessLoading = false;
  public witnessPageNo = 0;
  public witnessPageSize = 500;
  public witnessResultPage: ZilFlowRiskWitnessPage = {
    hasNextPage: false,
    records: [],
  };
  ...
  public addressTaintJobResultPage: ZilFlowAddressTaintJobResultPage = {
    hasNextPage: false,
    records: [],
  };
  ...
  public zilFlowRiskGraph: ZilFlowRiskGraph = {};
        ...
        linkDataArray: graph.edges
          ...
          .map((edge) => {
            return {
              ...
              text: cryptoPipe.transform(edge.amount, 'satoshi', 'zil') + ' ZIL',
  ...
  getEdgeWidth(satoshi: number) {
    ...
    const zil = pipe.transform(satoshi, 'satoshi', 'zil');
    if (zil < 0.1) {
      return 5;
    }
    if (zil < 0.5) {
