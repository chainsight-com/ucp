...
@Component({
  selector: 'app-xrp-scan-result-page',
  templateUrl: './xrp-scan-result-page.component.html',
  styleUrls: ['./xrp-scan-result-page.component.scss']
})
export class XrpScanResultPageComponent implements OnInit, OnDestroy {

  public isLoadingPipeline = false;
  public pipeline: XrpAddressScanPipeline = {};
  public isAddressTaintJobLoading = false;
  public addressTaintJobResultPageNo = 0;
  public addressTaintJobResultPageSize = 30;
  public addressTaintJobResultPage: XrpFlowAddressTaintJobResultPage = {
    hasNextPage: false,
    records: [],
  };


  public xrpFlowRiskGraph: XrpFlowRiskGraph = {};
  ...
  constructor(private router: Router,
              ...
              private xrpFlowAddressTaintJobApiService: XrpFlowAddressTaintJobApiService,
              private xrpFlowRiskGraphJobApiService: XrpFlowRiskGraphJobApiService) {
  }
        ...
        linkDataArray: graph.edges
          ...
          .map((edge) => {
            return {
              ...
              text: cryptoPipe.transform(edge.amount, 'satoshi', 'xrp') + ' XRP',
  ...
  getEdgeWidth(satoshi: number) {
    ...
    const xrp = pipe.transform(satoshi, 'satoshi', 'xrp');
    if (xrp < 0.1) {
      return 5;
    }
    if (xrp < 0.5) {
